...
class PaymentController {
    ...
    static async preauthorizePayment(req, res) {
    ...
    static async confirmCashPayment(req, res) {
      ...
      `, [tripId, passenger_id, driverId, amount, commissionAmount, netAmount]);
            ...
            const driverResult = await database_1.pool.query(`
    ...
    static async reportFailedCashPayment(req, res) {
    ...
    static async getDriverWallet(req, res) {
      ...
      `, [driverId]);
            ...
            const earningsResult = await database_1.pool.query(`
        SELECT 
