...
await pool.query(`CREATE INDEX IF NOT EXISTS idx_panic_alerts_trip ON panic_alerts(trip_id)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_panic_alerts_unresolved ON panic_alerts(user_id, is_resolved) WHERE is_resolved = false`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_trip_recordings_trip ON trip_recordings(trip_id)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_reservations_date ON trip_reservations(scheduled_date)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_reservations_status ON trip_reservations(status)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_earnings_driver ON driver_earnings(driver_id)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_notifications_user ON notifications(user_id)`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_notifications_unread ON notifications(user_id) WHERE is_read = false`);
await pool.query(`CREATE INDEX IF NOT EXISTS idx_route_changes_trip ON route_changes(trip_id)`);
